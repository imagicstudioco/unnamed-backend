const campaigns = [
  {
    ...
    description:
      "Help preserve our historic local theater for future generations.",
  ...
  },
  {
    ...
    description:
      "Support education by helping us build a new library for students.",
...
export default { campaigns, users };
